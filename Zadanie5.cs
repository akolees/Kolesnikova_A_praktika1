...
namespace HelloApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Нажмите ENTER, чтобы файл {path}test.zip был удалён:");
            ...
            Console.WriteLine();
            Console.WriteLine($"Нажмите ENTER, чтобы файл {path}newtest был  удалён:");
